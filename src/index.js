...
const mojCivilRoute = require("./modules/MojCivil/routes");
const taxRouter = require("./modules/Tax/routes");
const mlsaRouter = require("./modules/MLSA/routes");
const mcsRouter = require("./modules/MCS/routes");
...
app.use("/api/moj-civil", mojCivilRoute);
app.use("/api/mlsa", mlsaRouter);
app.use("/api/mcs", mcsRouter);
